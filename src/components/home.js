              ...
              <div className="tag-line-section-2">
                <div className="tag-line-section-2-div-2">
                  <p className="faded-paragraph">
                    To use digital health innovations and solutions to support
                    the provision of quality and sustainable health care
                    services to all Tanzanians so that they can effectively
                    participate in sustainable industrial and social
                    development.
                  </p>
